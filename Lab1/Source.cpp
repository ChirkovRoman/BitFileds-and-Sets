...
void operations()
{
	...
	cout << "Введите наибольший возможный элемент" << endl;
	cin >> n;
	TSet A(n + 1);
	cin >> A;
	...
	cout << A << endl;
	cout << "Всего элементов " << A.GetPower() << endl << endl;
	...
	cout << "Введённое множество" << endl;
	cout << B << endl;
	cout << "Всего элементов " << B.GetPower() << endl << endl;
	...
	while (input != -1) {
		cout << "Выберите дальнейшее действие:" << endl
			...
			<< "\t-1. Завершить работу c этими множествами" << endl;
		cin >> input;
